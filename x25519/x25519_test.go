...
func TestX25519(t *testing.T) {
	sk1 := sha256.Sum256([]byte("test1")) // 1b4f0e9851971998e732078544c96b36c3d01cedf7caa332359d6f1d83567014
	sk2 := sha256.Sum256([]byte("test2")) // 60303ae22b998861bce3b28f33eec1be758a213c86c93c076dbe9f558c11c752
	pk1 := Public(&sk1)
	pk2 := Public(&sk2)
